...
public class ThreadLoadApplist extends Thread {
	...
	public ThreadLoadApplist(Context context, List<AppInfo> appList,
	...
	public void run() {
		...
		// 执行完毕后进行界面更新
		handler.sendEmptyMessage(AppConstants.MSG_ON_BACKGROUND_CALCULATION);
	}
